...
<%
	...
	String storyKey = request.getParameter("s");
...
<body>
		...
		<div id="main">
			<div id="twocolumns">
				...
				<div id="content">
					...
					<div class="posts">
					<%
						// cutting out stories if in focus mode
						if (storyKey == null) {
					%>
						<!-- post item -->
						<%
						...
						<div class="post">
							...
							<div class="holder">
								...
								<span class="more">
									<!--
									<% out.println("<a href=\"/?s=" + story.getKey().getId() + "#disqus_thread\" onMouseDown=\"this.href='?s=" + story.getKey().getId() + "'\">"); %>Comments<%= "</a>" %>
									<font color="#949494">&bull;</font>
									-->
									<% out.println("<a href=\"" + story.getUrl() + "\" onMouseDown=\"this.href='/redirect?url=" + story.getUrl() + "&type=" + Click.Type.STORY + "&src=" + Click.Source.STORY_READ_MORE + "&fkey=" + feed.getKey().getId() + "&skey=" + story.getKey().getId() + "'\">"); %>Read More &raquo;<%= "</a>" %>
								</span>
							</div>
							<!-- social -->
							<ul class="social">
					...
					<%
							...
							Story story = persistenceManager.getObjectById(Story.class, Integer.parseInt(storyKey));
							Feed feed = persistenceManager.getObjectById(Feed.class, Integer.parseInt(story.getSourceFeedKey()));
					%>
						...
						<div class="post">
							<jsp:include page="/inc/comments/comment-block.tpl" />
						</div>
					
					<%
						}  // focus mode detection end
					%>
					</div>
					<!-- paging -->
					<%
						// cutting out pagination when in focus mode
						if (storyKey == null) {
					%>
					<div class="paging">
						<ul>
							...
							<li class="next"><a href="/?page=2">Next &raquo;</a></li>
							<%
							...
							<li><a href="/?page=4">4</a></li>
							<li><a href="/?page=5">5</a></li>
							<li class="next"><a href="/?page=3">Next &raquo;</a></li>
							<%
							} else if (currentPage == 3) {
							%>
							<li class="prev"><a href="/?page=2">&laquo; Prev</a></li>
							<li><a href="/?page=1">1</a></li>
							<li><a href="/?page=2">2</a></li>
							<li><strong>3</strong></li>
							<li><a href="/?page=4">4</a></li>
							<li><a href="/?page=5">5</a></li>
							<li class="next"><a href="/?page=4">Next &raquo;</a></li>
							<%
							} else if (currentPage > 3) {
							%>
							<li class="prev"><a href="/?page=<%= currentPage - 1 %>">&laquo; Prev</a></li>
							...
							<li><a href="/?page=<%= currentPage + 1 %>"><%= currentPage + 1 %></a></li>
							<li><a href="/?page=<%= currentPage + 2 %>"><%= currentPage + 2 %></a></li>
							<li class="next"><a href="/?page=<%= currentPage + 1 %>">Next &raquo;</a></li>
							<%
							}
							%>
	...
	<jsp:include page="/inc/comments/disqus.tpl" />
</body>
</html>
