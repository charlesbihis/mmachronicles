		...
		<div id="main">
			<div id="twocolumns">
				...
				<div id="content">
					<div class="about">
						<h2>Oops!</h2>
						<p>Looks like something's broken.  If this is still here after 5 minutes...then wait longer.</p>
						<p>...or, you could <a href="mailto:problem@mmachronicles.com">let us know</a> about it and we'll fix it, I guess.</p>
					</div>
				</div>
